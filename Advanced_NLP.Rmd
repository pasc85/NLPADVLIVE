...
<br>
&nbsp;
![](C:/IR Course/Adv -IR/pict64.png)
<br>
&nbsp;
![](C:/IR Course/Adv -IR/pict65.png)
...
<br> 
&nbsp;
As for many ML tasks, it is possible to generate useful feature. For example:<br> 
&nbsp;
...
TF-IDF vectors have been chosen represent the documents in our corpus due to its simplicity and speed in the creation of vectors.<br>
&nbsp;


ngram_range: We want to consider both unigrams and bigrams.<br>
&nbsp;
max_df: When building the vocabulary ignore terms that have a document frequency strictly higher than the given threshold. <br>
&nbsp;
...
&nbsp;
max_features: If not None, build a vocabulary that only consider the top max_features ordered by term frequency across the corpus.<br>
&nbsp;
See **TfidfVectorizer** in scilearn for further detail.<br>
&nbsp;
...
&nbsp;
4. Describe how sentiment analysis can be undertaken.<br>
&nbsp;
...
### 4.1 What is Sentiment Analysis<br>
&nbsp;
&nbsp;
...
Sentiment analysis systems allows companies to make sense of the sea of unstructured text by automating business processes, getting actionable insights, and saving hours of manual data processing.<br>
...
### 4.3 Advantages of sentiment analysis <br>
&nbsp;
...
### 4.4 Practical Sentiment Analysis <br>
&nbsp;
...
In a more practical sense, the objective here is to takes text and
produces a label (or labels) that summarizes the sentiment of this text, e.g. positive, neutral, and negative.<br>
&nbsp;
...
In the code above, we define that the max_features should be 2500, which means that it only uses the<br>
...
Similarly, max_df specifies that only use those words that occur in a maximum of 80% of the documents. <br>
&nbsp;Words that occur in all documents are too common and are not very useful for classification.<br>
